...
- 可编辑设备名称、设备信息与激活就绪状态、带真实图标和运行状态的 App 浏览、启动、重启与停止、 IPA 安装、安全卸载、App Documents 文件管理、受限的标准 AFC 文件与目录管理、硬件键锁屏、 确认式重启与关机、描述文件检查、校验安装和确认移除、有界崩溃报告浏览与导出，以及可取消的 CoreDevice sysdiagnose 采集
