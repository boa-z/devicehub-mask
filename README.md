...
| Key mapping | [Key Mapping Guide](docs/en/key-mapping.md) | [按键映射使用指南](docs/zh-CN/key-mapping.md) |
| Agent automation | [MCP Automation Guide](docs/en/mcp.md) | [MCP 自动化指南](docs/zh-CN/mcp.md) |
