...
use crate::protocol::VideoCounters;
...
impl RtcpShared {
    ...
    pub(super) fn reset_media_source(&mut self, ssrc: u32) {
        self.media_ssrc = Some(ssrc);
        self.stats = ReceptionStats::default();
    }

    pub(super) fn note_rtp_packet(&mut self, ssrc: u32, sequence: u16, marker: bool) {
...
pub(super) async fn receive_task(
