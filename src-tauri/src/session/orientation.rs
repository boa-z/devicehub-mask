...
use crate::protocol::{Orientation, OrientationSlot};

const POLL_INTERVAL: Duration = Duration::from_millis(500);

pub(super) struct OrientationWatcher(SpringBoardServicesClient);
...
impl OrientationWatcher {
    ...
    pub(super) async fn run(mut self, view: OrientationSlot) {
